    ...
    <AnimatePresence>
      {id && meta && (
        <motion.aside
          ...
          className="pointer-events-auto absolute bottom-0 left-[56px] top-12 z-30 flex w-[340px] flex-col border-r border-white/[0.06] bg-[#070b14]/90 shadow-[24px_0_60px_-40px_rgba(0,0,0,0.95)] backdrop-blur-xl"
        >
